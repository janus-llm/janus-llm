...
def combine_outputs(main_outputs, intermediate_outputs):
    ...
    for entry in main_outputs:
        ...
        if question_id in combined_outputs:
            ...
            combined_outputs[question_id]['selected-answer-number'] = entry.get('selected-answer-number', '')
            ...
            combined_outputs[question_id]['grading-result'] = (correct_answer == selected_answer)
...
def quiz_to_csv(quiz, file_path):
    ...
    headers = [
        'question-id', 'question', 'option-1', 'option-2', 'option-3', 'option-4',
        'correct-answer-number', 'reasoning', 'selected-answer-number', 'grading-result'
    ]
...
# Filepaths
input_file_path = '/home/faithmorgan/janus_dev/test_docs/quiz_taker_outputs/converter.json'
output_file_path = '/home/faithmorgan/janus_dev/test_docs/quiz_grader_outputs/quiz_output.csv'
