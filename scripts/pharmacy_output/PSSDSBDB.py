# BIR/RTR-Data used to populate Dose Unit and Numeric Dose for Dose Check
# 02/12/09
...
for PSSQVCEE in range(1, len(SET5) + 1):
    PSSQVCFF = SET5[PSSQVCEE-1]
    parts = PSSQVCFF.split(";;")
    key = parts[1]
    value = parts[2] + "^" + parts[3]
    TMP_J_data = "^TMP($J,\"PSSQVCS5\","
    globals()[TMP_J_data + key + ")"] = value