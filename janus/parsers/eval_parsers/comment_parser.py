...
class CommentParser(PydanticOutputParser, JanusParser):
    ...
    def get_format_instructions(self) -> str:
        ...
        return (
            ...
            "in a JSON-formatted string. For each and every comment there should "
            "and be evaluated criteria  Completeness, Hallucination, Readability, "
            "and Usefulness each including: "
